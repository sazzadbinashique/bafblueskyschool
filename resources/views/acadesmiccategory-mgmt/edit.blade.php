...
<div class="col-md-12">
        <form role="form" method="POST" action="{{ route('acadesmiccategory-mgmt.update', [$Data->id]) }}" >
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="card-footer">
                ...
                <div class="btn-group mr-2">
                    <a href="{{ url('acadesmiccategory-mgmt') }}" class=" btn btn-primary " data-toggle="tooltip"
