...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>|| Facility Category||</h5>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Facility Category </li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <script>
            ...
            $(document).ready(function() {
                var table1Config = configureDataTable('Facility Categories List', 'Facility Categories List', null);
                // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
                $('#facilitycat_table').DataTable(table1Config).buttons().container().appendTo('#facilitycat_table_wrapper .col-md-6:eq(0)');
                $("#facilitycat_table thead th").css({
