...
@section('content')
    ...
    <section class="content">
        ...
        <script>
            ...
            $(document).ready(function() {
                var table1Config = configureDataTable('Gallery Categories List', 'Gallery Categories List', null);
                // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
                $('#gallerycat_table').DataTable(table1Config).buttons().container().appendTo('#gallerycat_table_wrapper .col-md-6:eq(0)');
                $("#gallerycat_table thead th").css({
