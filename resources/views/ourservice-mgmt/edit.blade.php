...
<section class="content">
    <div class="col-md-12">
        <form role="form" method="POST" action="{{ route('ourservice-mgmt.update', [$data->id]) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2"
                                                        ...
                                                        @foreach ($ourserviceCats as $ourserviceCat)
                                                            <option value="{{$ourserviceCat->id}}"<?=$ourserviceCat->id == $data->ourservice_cat_id ? ' selected="selected"' : '';?>>{{$ourserviceCat->name}}</option>
                                                        @endforeach
            ...
            <div class="card-footer">
                <div class="btn-group mr-2">
                    <a href="{{ url('ourservice-mgmt') }}" class=" btn btn-primary " data-toggle="tooltip"  data-placement="left" title="edit">Back</a>
                </div>
