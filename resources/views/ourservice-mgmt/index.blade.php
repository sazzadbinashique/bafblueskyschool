    ...
    <section class="content">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <form role="form" method="POST" action="{{ route('ourservice-mgmt.store') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label>Our Service Category</label>
                                                            <div class="row">
                                                                <div class="col-sm-10">
                                                                    <select class="form-control select2"
                                                                            style="width: 100%;" name="ourservice_cat_id">
                                                                        @foreach ($ourserviceCats as $ourserviceCat)
                                                                            <option
                                                                                value="{{$ourserviceCat->id}}">{{$ourserviceCat->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-2">
                        ...
                        <div class="modal fade" id="modal-storecat">
                            <form role="form" method="POST" action="{{ route('ourservice-mgmt.storeCategory') }}">
                                {{ csrf_field() }}
                    ...
                    <table id="ourservice_table" class="table table-striped table-bordered">
                        <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 15%; overflow: hidden; text-align: center;">
                                    ...
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('ourservice-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('ourservice-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
                                        <i class="fas fa-trash" style="font-size: 12px;color: #7c151f;"></i> Delete
                                    </a>
                                    <a class="btn btn-outline-primary btn-sm"
                                       href="{{ route('ourservice-mgmt.show', [$data->id]) }}" data-placement="left"
                                       title="Show">
