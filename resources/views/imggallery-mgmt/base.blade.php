...
<section class="content">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table1Config = configureDataTable('Image Gallery  List', 'Image Gallery List', null);
            // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
            $('#image_gallery_table').DataTable(table1Config).buttons().container().appendTo('#image_gallery_table_wrapper .col-md-6:eq(0)');
            $("#image_gallery_table thead th").css({
