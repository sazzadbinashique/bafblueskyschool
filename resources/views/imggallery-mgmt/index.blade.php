    ...
    <section class="content">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <form role="form" method="POST" action="{{ route('imggallery-mgmt.store') }}"
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select class="form-control select2"
                                                                        ...
                                                                        @foreach ($galleryCats as $galleryCat)
                                                                            <option
                                                                                value="{{$galleryCat->id}}">{{$galleryCat->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-2">
                        ...
                        <div class="modal fade" id="modal-storecat">
                            <form role="form" method="POST" action="{{ route('imggallery-mgmt.storeCategory') }}">
                                {{ csrf_field() }}
                    ...
                    <table id="image_gallery_table" class="table table-striped table-bordered">
                        <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 15%; overflow: hidden; text-align: center;">
                                    ...
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('imggallery-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('imggallery-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
                                        <i class="fas fa-trash" style="font-size: 12px;color: #7c151f;"></i> Delete
                                    </a>
                                    <a class="btn btn-outline-primary btn-sm"
                                       href="{{ route('imggallery-mgmt.show', [$data->id]) }}" data-placement="left"
                                       title="Show">
