...
<section class="content">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table1Config = configureDataTable('Academic Notice  List', 'Academic Notice List', null);
            // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
            $('#academic_notice_table').DataTable(table1Config).buttons().container().appendTo('#academic_notice_table_wrapper .col-md-6:eq(0)');
            $("#academic_notice_table thead th").css({
