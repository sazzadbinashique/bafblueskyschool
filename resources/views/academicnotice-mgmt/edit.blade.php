...
<section class="content">
    <div class="col-md-12">
        <form role="form" method="POST" action="{{ route('academicnotice-mgmt.update', [$data->id]) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2"
                                                        ...
                                                        @foreach ($academicnoticelists as $academicnoticelist)
                                                            <option value="{{$academicnoticelist->id}}"<?=$academicnoticelist->id == $data->academicnotice_cat_id ? ' selected="selected"' : '';?>>{{$academicnoticelist->name}}</option>
                                                        @endforeach
            ...
            <div class="card-footer">
                <div class="btn-group mr-2">
                    <a href="{{ url('academicnotice-mgmt') }}" class=" btn btn-primary " data-toggle="tooltip"  data-placement="left" title="edit">Back</a>
                </div>
