    ...
    <section class="content">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <form role="form" method="POST" action="{{ route('admissionnotice-mgmt.store') }}"
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select class="form-control select2"
                                                                        ...
                                                                        @foreach ($admissionnoticelists as $admissionnoticelist)
                                                                            <option
                                                                                value="{{$admissionnoticelist->id}}">{{$admissionnoticelist->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-3">
                        ...
                        <div class="modal fade" id="modal-storecat">
                            <form role="form" method="POST" action="{{ route('admissionnotice-mgmt.storeCategory') }}">
                                {{ csrf_field() }}
                            ...
                            <tr>
                                ...
                                @can('admissionnotice-list')
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('admissionnotice-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('admissionnotice-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
