...
<section class="content">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table1Config = configureDataTable('Facility List', 'Facility List', null);
            // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
            $('#facilities_table').DataTable(table1Config).buttons().container().appendTo('#facilities_table_wrapper .col-md-6:eq(0)');
            $("#facilities_table thead th").css({
