...
<section class="content">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table1Config = configureDataTable('School History', 'School History', null);
            // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
            $('#schoolhistory_table').DataTable(table1Config).buttons().container().appendTo('#schoolhistory_table_wrapper .col-md-6:eq(0)');
            $("#schoolhistory_table thead th").css({
