...
@section('action-content')
    ...
    <section class="content">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <a type="button" href="{{ route('schoolhistory-mgmt.create') }}" class="btn btn-primary">Create
                                New</a>
                        </div>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <table id="schoolhistory_table" class="table table-striped table-bordered">
                        ...
                        @foreach ($datas as $data)
                            ...
                            <tr>
                                <td>{{ $count }}</td>
                                <td>{{ $data->aboutus_title }}</td>
                                <td>{{ $data->aboutus_detail }}</td>
                                ...
                                <td style="width: 200px;  text-align: center;">
                                    ...
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('schoolhistory-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('schoolhistory-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
