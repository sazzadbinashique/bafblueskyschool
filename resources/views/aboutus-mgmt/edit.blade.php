...
<section class="content">
    <div class="col-md-12">
        <form role="form" method="POST" action="{{ route('aboutus-mgmt.update', [$data->id]) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2"
                                                        ...
                                                        @foreach ($aboutusCats as $aboutusCat)
                                                            <option value="{{$aboutusCat->id}}"<?=$aboutusCat->id == $data->aboutus_cat_id ? ' selected="selected"' : '';?>>{{$aboutusCat->name}}</option>
                                                        @endforeach
