...
<section class="content">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table1Config = configureDataTable('About Us  List', 'About Us List', null);
            // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
            $('#aboutus_table').DataTable(table1Config).buttons().container().appendTo('#aboutus_table_wrapper .col-md-6:eq(0)');
            $("#aboutus_table thead th").css({
