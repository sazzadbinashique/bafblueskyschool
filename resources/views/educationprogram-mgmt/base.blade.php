...
<section class="content">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table1Config = configureDataTable('Education Image  List', 'Education Image List', null);
            // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
            $('#education_program_table').DataTable(table1Config).buttons().container().appendTo('#education_program_table_wrapper .col-md-6:eq(0)');
            $("#education_program_table thead th").css({
