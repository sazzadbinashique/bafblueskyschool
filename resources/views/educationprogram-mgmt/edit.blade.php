...
<section class="content">
    <div class="col-md-12">
        <form role="form" method="POST" action="{{ route('educationprogram-mgmt.update', [$data->id]) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2"
                                                        ...
                                                        @foreach ($educationprogramCats as $educationprogramCat)
                                                            <option value="{{$educationprogramCat->id}}"<?=$educationprogramCat->id == $data->educationprogram_cat_id ? ' selected="selected"' : '';?>>{{$educationprogramCat->name}}</option>
                                                        @endforeach
            ...
            <div class="card-footer">
                <div class="btn-group mr-2">
                    <a href="{{ url('educationprogram-mgmt') }}" class=" btn btn-primary " data-toggle="tooltip"  data-placement="left" title="edit">Back</a>
                </div>
