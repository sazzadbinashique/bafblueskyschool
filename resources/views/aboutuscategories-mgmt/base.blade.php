...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>|| Aboutus Category||</h5>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Aboutus Category </li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <script>
            ...
            $(document).ready(function() {
                var table1Config = configureDataTable('Aboutus Categories List', 'Aboutus Categories List', null);
                // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
                $('#aboutuscat_table').DataTable(table1Config).buttons().container().appendTo('#aboutuscat_table_wrapper .col-md-6:eq(0)');
                $("#aboutuscat_table thead th").css({
