...
@section('content')
    ...
    <section class="content">
        ...
        <script>
            ...
            $(document).ready(function() {
                var table1Config = configureDataTable('Service Categories List', 'Service Categories List', null);
                // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
                $('#servicecat_table').DataTable(table1Config).buttons().container().appendTo('#servicecat_table_wrapper .col-md-6:eq(0)');
                $("#servicecat_table thead th").css({
