...
<section class="content">
    <div class="col-md-12">
        <form role="form" method="POST" action="{{ route('managingcommittee-mgmt.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" id="appointment_ser_no"
                                                       name="appointment_ser_no" placeholder="Appointment Ser No" value=""
                                                       required>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="card-footer">
                <div class="btn-group mr-2">
                    <a href="{{ url('managingcommittee-mgmt') }}" class=" btn btn-primary " data-toggle="tooltip"
