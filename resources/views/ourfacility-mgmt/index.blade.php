                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <a type="button" href="{{ route('ourfacility-mgmt.create') }}" class="btn btn-primary">Create
                                New</a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td style="min-width: 150px;  text-align: center;">
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('ourfacility-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('ourfacility-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
                                    ...
                                    <a class="btn btn-outline-primary btn-sm"
                                       href="{{ route('ourfacility-mgmt.show', [$data->id]) }}" data-placement="left"
                                       title="Show">
