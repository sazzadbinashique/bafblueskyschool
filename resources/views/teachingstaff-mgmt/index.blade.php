...
@section('action-content')
    ...
    <section class="content">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <a type="button" href="{{ route('teachingstaff-mgmt.create') }}" class="btn btn-primary">Create
                                New</a>
                        </div>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <table id="teachingstaff_datatable_back" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td style="min-width: 150px;  text-align: center;">
                                    ...
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('teachingstaff-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('teachingstaff-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
                                        <i class="fas fa-trash" style="font-size: 12px;color: #7c151f;"></i> Delete
                                    </a>
                                    <a class="btn btn-outline-primary btn-sm"
                                       href="{{ route('teachingstaff-mgmt.show', [$data->id]) }}" data-placement="left"
                                       title="Show">
