...
<section class="content">
    <div class="col-md-12">
        <form role="form" method="POST" action="{{ route('teachingstaff-mgmt.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-footer">
                <div class="btn-group mr-2">
                    <a href="{{ url('teachingstaff-mgmt') }}" class=" btn btn-primary " data-toggle="tooltip"
