                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <a type="button" href="{{ route('slideimage-mgmt.create') }}" class="btn btn-primary">Create
                                New</a>
                        </div>
                    </div>
                        ...
                        @foreach ($datas as $data)
                            ...
                            <tr>
                                ...
                                <td style="width: 60px; height: 60px; padding: 5px;">
                                    <img src="uploads/image/{{$data->slide_img}}" style="width: 100%; height: 100%;" alt="image">
                                </td>
                                <td style="min-width: 150px;  text-align: center;">
                                    <a class="btn btn-outline-secondary btn-sm"
                                       href="{{ route('slideimage-mgmt.edit', [$data->id]) }}" data-placement="left"
                                       title="Edit">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')"
                                       href="{{ route('slideimage-mgmt.remove', [$data->id]) }}"
                                       data-placement="left"
                                       title="Cancel">
                                    ...
                                    <a class="btn btn-outline-primary btn-sm"
                                       href="{{ route('slideimage-mgmt.show', [$data->id]) }}" data-placement="left"
                                       title="Show">
