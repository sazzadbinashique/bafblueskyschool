...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">History Category </li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <script>
            ...
            $(document).ready(function() {
                var table1Config = configureDataTable('Admission Category List', 'Admission Category List', null);
                // var table1Config = configureDataTable('Branch List', 'Branch List', [1,2]);
                $('#academic_cat_table').DataTable(table1Config).buttons().container().appendTo('#academic_cat_table_wrapper .col-md-6:eq(0)');
                $("#academic_cat_table thead th").css({
